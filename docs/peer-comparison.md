...
| 调度/保留 | 不支持 | 计划任务、保留点、自动清理、通知 | 只能手动启动 Rust GUI/CLI |
...
| UI/运维 | Rust Win32 原生 GUI、多语言、管理员自提升、模式字段显隐 | 更丰富的向导、队列、进度、取消、历史任务 | 当前长操作主要在 WinRE 中由 Rust Recovery 执行，GUI 进度/取消/历史浏览仍较弱 |
